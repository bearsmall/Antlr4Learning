...
public class SymtabManager {
     ...
     */
    static Scope[] scopeStack = new Scope[200];
    ...
    public static Scope OpenScope(String scopeName, boolean isType) {
        ...
        //System.out.println("=================================================++depth++"+newScope.scopeName);
        return newScope;
    }

    public static void OpenScope(Scope sc) {
    	//System.out.println("=================================================++depth++"+sc.scopeName);
        scopeStack[++depth] = sc;
    }
    ...
    /**
     * Returns the Scope of B in A::B::CTYPE.
     */
