...
public class ZZZCopyOfToken implements java.io.Serializable {
	 ...
	 * field is null.
	 */
	public ZZZCopyOfToken specialToken;
	 ...
	 */
	public ZZZCopyOfToken() {
	}

	/**
	 * Constructs a new token for the specified Image.
	 */
	public ZZZCopyOfToken(int kind) {
		this(kind, null);
	}
	 ...
	 */
	public ZZZCopyOfToken(int kind, String image) {
		this.kind = kind;
		this.image = image;
	}
	 ...
	 */
	public static ZZZCopyOfToken newToken(int ofKind, String image) {
		switch (ofKind) {
		default:
			return new ZZZCopyOfToken(ofKind, image);
		}
	}

	public static ZZZCopyOfToken newToken(int ofKind) {
		return newToken(ofKind, null);
	}

	int realKind = JavaTreeParserConstants.GT;

	// 这个函数是在编译.jj文件后在Token.java文件中添加的
	// public static class GTToken extends ZZZCopyOfToken
	// {
...
/*
 * JavaCC - OriginalChecksum=904f658a331881c8f7e76177f64f9ef5 (do not edit this
 * line)
 */
