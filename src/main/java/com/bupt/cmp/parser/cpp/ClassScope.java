...
public class ClassScope extends Scope
{
   ...
   {
      if (sc == null || sc == this) // TBD: distinguish diff. templates
	  return;                   // if sc == this --> trace
    ...
    */
   public ClassScope(String name, Scope parent, boolean nameSpaceScope)
   {
      super(name, true, parent, nameSpaceScope);
   }
}
