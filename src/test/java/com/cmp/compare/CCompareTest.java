...
public class CCompareTest {
    ...
    static {
        icodeFactory = CCodeFactory.getInstance();
        String src1 = CCompareTest.class.getClassLoader().getResource("language/c/junk1.c").getPath();
        String src2 = CCompareTest.class.getClassLoader().getResource("language/c/junk2.c").getPath();
