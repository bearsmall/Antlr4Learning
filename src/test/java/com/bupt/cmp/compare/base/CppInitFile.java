...
public class CppInitFile {
    ...
    public void test1(){//测试
        String folder = "E:\\User\\bearsmall\\html\\coding\\C_C++\\LuoYe\\c-json\\1491790210000\\c-json-master\\cJSON.h";
    ...
    private void iteratorFolder(File file) {
        ...
        }else if(file.isFile()&&file.getAbsolutePath().endsWith(".c")||file.getAbsolutePath().endsWith(".cpp")||file.getAbsolutePath().endsWith(".h")){
